...
void KEY1_EXTI_Init(void) {
    ...
    KEY_Init(); // 确保 GPIOE 时钟已开启

    RCC_APB2PeriphClockCmd(RCC_APB2Periph_AFIO, ENABLE); // 开启复用时钟
    GPIO_EXTILineConfig(GPIO_PortSourceGPIOE, GPIO_PinSource4); // PE4 映射到 EXTI4
...
void KEY0_EXTI_Init(void) {
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_AFIO, ENABLE); // 开启复用时钟
    GPIO_EXTILineConfig(GPIO_PortSourceGPIOE, GPIO_PinSource3); // PE3 映射到 EXTI3
